...
- (void)signupInfoView {
    ...
    {
        _name = [[FLTextFieldSignup alloc] initWithPlaceholder:@"FIELD_LASTNAME" for:_userDic key:@"lastName" position:CGPointMake(PADDING_SIDE, 0.0f) placeholder2:@"FIELD_FIRSTNAME" key2:@"firstName"];
