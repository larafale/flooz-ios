...
- (void)_setup {
    ...
    _doneLabel.text = NSLocalizedString(@"GLOBAL_THANKS", nil);
    _doneLabel.hidden = YES;
    _doneLabel.font = [UIFont customContentRegular:14];
