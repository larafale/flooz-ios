...
- (void)setNotification:(FLNotification *)notification {
...
- (void)prepareDateView {
	dateView.text = [FLHelper momentWithDate:[_notification date]]; //[_activity dateText];
