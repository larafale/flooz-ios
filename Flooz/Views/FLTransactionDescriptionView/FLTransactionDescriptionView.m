...
- (void)createSocialView {
    commentText = [[JTImageLabel alloc] initWithFrame:CGRectMake(0.0f, CGRectGetMaxY(attachmentView.frame), 40.0f, 12.0f)];
...
- (void)prepareLikeView {
    ...
    {
        [commentText setText:[self castNumber:social.commentsCount]];
        if (social.commentsCount == 0) {
            ...
            CGRectSetX(likeText.frame, 40.0f);
            CGRectSetWidth(likeText.frame, CGRectGetWidth(rightView.frame) - 40.0f);
        }
    }
